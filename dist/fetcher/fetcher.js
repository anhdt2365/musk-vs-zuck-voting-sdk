...
class AccountFetcher {
    ...
    // YOUR CODE:
    getBattle(address, refresh = false) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.get((0, anchor_1.translateAddress)(address), parsing_1.ParsableBattle, refresh);
        });
    }
    getUser(address, refresh = false) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.get((0, anchor_1.translateAddress)(address), parsing_1.ParsableUser, refresh);
        });
    }
}
