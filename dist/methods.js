...
class Methods {
    ...
    initialize(params) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ix = yield ixs.initialize(this.ctx.program, params);
            return this;
        });
    }
    voteMusk(params) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ix = yield ixs.voteMusk(this.ctx.program, params);
            return this;
        });
    }
    voteZuck(params) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ix = yield ixs.voteZuck(this.ctx.program, params);
            return this;
        });
    }
    toTx() {
